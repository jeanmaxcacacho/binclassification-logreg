...
From 51347 rows to 11274, about 4.56 times smaller!
```{r}
...
It can be seen from the bar graphs that both ROS and RUS approaches balance the training data to about the similar proportions.