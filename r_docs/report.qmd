...
continuous_attr2 <- c("age", "bmi", "HbA1c_level", "blood_glucose_level")

continuous_attr_notarg <- raw_df[, ..continuous_attr2]

par(mfrow = c(2, 2))
for (attr in continuous_attr2) {
  hist(continuous_attr_notarg[[attr]],
...
Scatterplot matrices help explore pairwise relationships between the attributes and identify patterns and clusters.
```{r}
# kekma.net
```
